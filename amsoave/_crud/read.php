...
Description: 	This php program prints out the information (name, email, and phone) for the specific user selected.
...
<body>
    <div class="container">
				...
				<img src="../svsu.jpg" class="img-responsive pull-right" alt="SVSU Cardinals" align="right" title="SVSU" id="read">
    			 <div class="span10 offset1">
				 <!-- put the h2 inside of a container-fluid and also used in-line style -->
