...
<head>
    <meta charset="utf-8">
	<!-- 8. Here is an example of specificity... My css is last which means it is going to be the most important styling on this page-->
    		...
    		<figure>
				<img  src="img/snowPlow.jpg" width="200" height="100">
	    			...
	    			<form class="form-horizontal" action="create.php" method="post">
					  ...
					  <div style = background-color:#222121; class="form-actions">
						  <button type="submit" class="btn btn-success"> <span class="glyphicon glyphicon-plus"></span> </button>
						  <a  class="btn-back" href="index.php"><span class=" glyphicon-arrow-left"></span> </a>
